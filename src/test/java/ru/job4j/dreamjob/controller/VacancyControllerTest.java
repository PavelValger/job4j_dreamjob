...
class VacancyControllerTest {
    ...
    @Test
    public void whenGetByIdVacancyThenGetToOnePage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var model = new ConcurrentModel();
    ...
    @Test
    public void whenGetByIdVacancySomeExceptionThrownThenGetErrorPageWithMessage() {
    ...
    @Test
    public void whenUpdateVacancySomeExceptionThrownThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
