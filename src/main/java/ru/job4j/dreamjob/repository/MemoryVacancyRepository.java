...
public class MemoryVacancyRepository implements VacancyRepository {
    ...
    public MemoryVacancyRepository() {
        ...
        save(new Vacancy(0, "Intern Java Developer", "", dateTime, false, 1, 0));
        save(new Vacancy(0, "Junior Java Developer", "", dateTime, false, 2, 0));
        save(new Vacancy(0, "Junior+ Java Developer", "", dateTime, false, 3, 0));
        save(new Vacancy(0, "Middle Java Developer", "", dateTime, false, 1, 0));
        save(new Vacancy(0, "Middle+ Java Developer", "", dateTime, false, 2, 0));
        save(new Vacancy(0, "Senior Java Developer", "", dateTime, false, 3, 0));
    }
